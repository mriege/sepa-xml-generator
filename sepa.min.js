(function (t) {
  ...
  function h(t) {
    ...
    this._type = u[this._painFormat];
    this._paymentInfo = [];
    this._xmlVersion = n;
    this._xmlEncoding = e;
    this.grpHdr = new m(this._painFormat)
  }
  h.Types = u;
  h.prototype = {
    _painFormat: null,
    ...
    toXML: function () {
      ...
      var r = n.createElementNS(t, this._type);
      r.appendChild(this.grpHdr.toXML(n));
      for (var i = 0, o = this._paymentInfo.length; i < o; ++i) {
        r.appendChild(this._paymentInfo[i].toXML(n))
      }
  ...
  m.prototype = {
    ...
    toXML: function (t) {
      ...
      var r = l(this._painFormat);
      n(e, "MsgId", this.id);
      n(e, "CreDtTm", this.created.toISOString());
      if (r === 2) {
        n(e, "BtchBookg", this.batchBooking.toString())
      }
      n(e, "NbOfTxs", this.transactionCount);
      n(e, "CtrlSum", this.controlSum.toFixed(2));
      if (r === 2) {
        n(e, "Grpg", this.grouping)
      }
      n(e, "InitgPty", "Nm", this.initiatorName);
      return e
    },
    toString: function () {
      return L(this.toXML())
  ...
  p.prototype = {
    ...
    toXML: function (t) {
      ...
      var n = M(t, true, false);
      var e = M(t, true, true);
      var r = t.createElementNS(t.documentElement.namespaceURI, "PmtInf");
      e(r, "PmtInfId", this.id);
      e(r, "PmtMtd", this.method);
      ...
      e(i, "SvcLvl", "Cd", "SEPA");
      if (this.method === f.DirectDebit) {
        e(i, "LclInstrm", "Cd", this.localInstrumentation);
        e(i, "SeqTp", this.sequenceType);
      ...
      if (this[o + "Street"] && this[o + "City"] && this[o + "Country"]) {
        var d = n(s, "PstlAdr");
        e(d, "Ctry", this[o + "Country"]);
        e(d, "AdrLine", this[o + "Street"]);
        e(d, "AdrLine", this[o + "City"])
      }
  ...
  y.prototype = {
    ...
    validate: function () {
      ...
      w(this.end2endId, "end2endId");
      N(this.amount, .01, 999999999.99, "amount");
      _(this.amount == this.amount.toFixed(2), "amount has too many fractional digits");
      A(this.purposeCode, 1, 4, "purposeCode");
      F(this.mandateId, "mandateId");
      T(this.mandateSignatureDate, "mandateSignatureDate");
      A(this[t + "Name"], null, 70, t + "Name");
      A(this[t + "Street"], null, 70, t + "Street");
      A(this[t + "City"], null, 70, t + "City");
      A(this[t + "Country"], null, 2, t + "Country");
      E(this[t + "IBAN"], t + "IBAN");
      console.log(this[t + "BIC"]);
    ...
    toXML: function (t) {
      ...
      var r = M(t, true, false);
      var i = M(t, false, true);
      var o = M(t, true, true);
      var a = t.createElementNS(t.documentElement.namespaceURI, this._type);
      var s = r(a, "PmtId");
      o(s, "InstrId", this.id);
      o(s, "EndToEndId", this.end2endId);
      if (this._type === I.DirectDebit) {
        ...
        o(d, "MndtId", this.mandateId);
        o(d, "DtOfSgntr", this.mandateSignatureDate.toISOString().substr(0, 10));
        if (this.ammendment) {
          o(d, "AmdmntInd", "true");
  ...
  function M(i, o, a) {
    return function () {
      var t = arguments[0];
      var n = a && arguments[arguments.length - 1];
      var e = a ? arguments.length - 1 : arguments.length;
      if (o || n || n === 0) {
        for (var r = 1; r < e; ++r) {
  ...
  t.validateIBAN = g;
  t.checksumIBAN = b;
  t.validateCreditorID = D;
  t.checksumCreditorID = S;
  t.setIDSeparator = o;
  t.enableValidations = d
